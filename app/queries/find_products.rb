class FindProducts
    ...
    def filter_by_favorites(scoped, favorites)
      ...
      #Este scope es para filtrar los favoritos de acuerdo al usuario, si no ponemos el WHERE, va a tirar el listado de TODOS los favoritos independientemente si son varios usuarios o no
